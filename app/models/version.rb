...
class Version < ApplicationRecord
  ...
  def self.ransackable_attributes(_auth_object = nil)
    %w[created_at description id version_number part_id file_path scale sheet_size unit
       drawn_by checked_by approved_by drawn_date status updated_at]
  end
  ...
  def generate_version_number
    return unless part.present? && part.part_number.present?
