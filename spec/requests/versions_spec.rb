...
RSpec.describe "Versions", type: :request do
  ...
  let(:valid_attributes) {
    { version_number_suffix: "001", description: "Version 1", scale: "1:1", sheet_size: "A4", unit: "mm", drawn_by: "User", checked_by: "User2", approved_by: "User3", drawn_date: "2023-01-01" }
  }
