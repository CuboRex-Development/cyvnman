...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference("Block.count") do
      post blocks_url, params: { block: { block_name: @block.block_name, block_number: @block.block_number, description: @block.description } }
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { block_name: @block.block_name, block_number: @block.block_number, description: @block.description } }
