...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference("Type.count") do
      post types_url, params: { type: { description: @type.description, type_name: @type.type_name, type_number: @type.type_number } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { description: @type.description, type_name: @type.type_name, type_number: @type.type_number } }
