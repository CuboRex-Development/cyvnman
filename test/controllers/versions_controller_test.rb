...
class VersionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create version" do
    assert_difference("Version.count") do
      post versions_url, params: { version: { description: @version.description, part_id: @version.part_id, version_number: @version.version_number } }
    end
  ...
  test "should update version" do
    patch version_url(@version), params: { version: { description: @version.description, part_id: @version.part_id, version_number: @version.version_number } }
